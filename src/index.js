...
fastify.addHook("onRequest", async (request, reply) => {
  if (gooners.includes(request.ip)) {
    reply.code(200).send({ error: `You have been identified as a gooner. Your IP, ${request.ip} has been traced and reported to the FBI. Join https://discord.gg/g3adAQEHVZ to appeal` });
